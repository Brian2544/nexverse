...
const steps = [
  ...
  {
    title: 'Execution',
    description: 'Implementing solutions with precision and expertise',
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
    ...
    <section className="section bg-primary">
      <div className="container">
        ...
        <div className="relative">
          {/* Connection Line */}
          <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-0.5 bg-secondary/20 -translate-y-1/2" />
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="bg-primary-light p-8 rounded-lg text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary text-secondary mb-6">
                    {step.icon}
                  </div>
                ...
                {/* Step Number */}
                <div className="absolute -top-4 -left-4 w-8 h-8 rounded-full bg-secondary text-primary flex items-center justify-center font-bold">
                  {index + 1}
                </div>
              </motion.div>
            ))}
